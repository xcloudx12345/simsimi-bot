module.exports.run = (client, message, args) ->
    ...
    if simchannel != message.channel.id || simchannel == null
        ...
        client.createMessage message.channel.id,"""Sim sẽ trả lời trong channel này (<##{channel.id}>)!"""
    else
        client.createMessage message.channel.id,"""Sim đã ở đây rồi (<##{channel.id}>)!"""
